...
<header class="header" id="site-header">
    ...
    <div class="container">
        ...
        <div class="header-content-wrapper">
            ...
            <div>
                <a class="btn btn-info" href="/searchpage"> Search Product</a>
                        ...
                        <div class="popup-cart">
                            ...
                            <a href="/wishlist">
                                <div class="btn btn-small btn--dark">
                                    <span class="text">View WishList</span>
                                </div>
                            </a>
                        </div>
                    </div>
        ...
        <div class="row pt120">
            <div class="col-lg-8 col-lg-offset-2">
                <div class="heading align-center mb60">
                    <h4 class="h1 heading-title">Alpha Sports Store</h4>
                    <p class="heading-text">Buy Soccer Products Here.
                    </p>
                </div>
            </div>
        </div>
